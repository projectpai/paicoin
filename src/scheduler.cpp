...
static boost::system_time toPosixTime(const std::chrono::system_clock::time_point& t)
{
    ...
    return boost::posix_time::from_time_t(0) + boost::posix_time::milliseconds(std::chrono::duration_cast<std::chrono::milliseconds>(t.time_since_epoch()).count());
}
#endif
...
void CScheduler::scheduleFromNow(CScheduler::Function f, int64_t deltaMilliSeconds)
{
    ...
    timeout += std::chrono::milliseconds(deltaMilliSeconds);
    schedule(f, timeout);
}
