...
bool CPAIcoinSecret::IsValid() const
{
...
bool CPAIcoinSecret::SetString(const char* pszSecret)
{
    return CBase58Data::SetString(pszSecret) && IsValid();
}

bool CPAIcoinSecret::SetString(const std::string& strSecret)
{
