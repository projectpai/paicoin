...
int32_t calcWantHeight(int32_t stakeValidationHeight, uint32_t interval, uint32_t height)
{
    ...
    uint32_t intervalOffset = stakeValidationHeight % interval;
    uint32_t adjustedHeight = height - intervalOffset - 1;
