...
#ifndef PAICOIN_TEST_SCRIPTNUM10_H
#define PAICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from PAI Coin Core 0.10.0, for cross-comparison.
 */
public:
