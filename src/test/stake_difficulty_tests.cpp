    ...
    const auto& tests = std::vector<CalculateSDiffTest>{
        ...
        // we changed some of the values
        {
            ...
            "31st retarget interval, waning demand",
            {
                ...
                {144, 0, 30601226310},    // 4319
                {144, 0, 51880090400},    // 4463
            },
            81756591796,
        },
    };
    ...
    const auto& tests = std::vector<EstimateSDiffTest>{
        ...
        },
        {
            ...
            "9th retarget interval, varying demand, 137th block",
            {
                ...
                {144, 20, 833888965},           // 1007
                { 76, 10, 3047415760},          // 1083
                {  9,  0, 3047415760},          // 1092
                {  1, 10, 3047415760},          // 1093
                {  8,  0, 3047415760},          // 1101
                {  1, 10, 3047415760},          // 1102
                { 12,  0, 3047415760},          // 1114
                {  1, 10, 3047415760},          // 1115
                {  9,  0, 3047415760},          // 1124
                {  1, 10, 3047415760},          // 1125
                {  8,  0, 3047415760},          // 1133
                {  1, 10, 3047415760},          // 1134
                { 10,  0, 3047415760},          // 1144
            },
            10,
            false,
            10083184596,
        },
        {
            ...
            "11th retarget interval, 50% demand, 127th block",
            {
                ...
                {144, 10, 39289988},            // 719
                {144, 10, 66729608},            // 863
                {144, 10, 130833465},           // 1007
                {144, 10, 291484540},           // 1151
                {144, 10, 728120227},           // 1295
                {127, 10, 2016733002},          // 1422
            },
            170, // 17 * 10
            false,
            6145030006,
