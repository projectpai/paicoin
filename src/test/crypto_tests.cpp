...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As PAIcoin relies on 80 byte header hashes, we want to have an example for that.",
               "619cd4e87889698af6b88444bf7d1effbb9cf49257a0a16973c9f0cf17f79572");
