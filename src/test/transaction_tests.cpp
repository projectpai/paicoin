...
BOOST_AUTO_TEST_CASE(test_IsStandard)
{
    ...
    t.vout[0].scriptPubKey = CScript() << OP_RETURN << ParseHex("00DAE69F877C357A193BB782BEBA2FE506C1179C21850B47DC5228C592CF800E05BCD515FD27937A00DAE69F877C357A193BB782BEBA2FE506C1179C21850B47DC5228C592CF800E05BCD515FD27937A");
    BOOST_CHECK_EQUAL(MAX_OP_RETURN_RELAY, t.vout[0].scriptPubKey.size());
    BOOST_CHECK(IsStandardTx(t, reason));

    // MAX_OP_RETURN_RELAY+1-byte TX_NULL_DATA (non-standard)
    t.vout[0].scriptPubKey = CScript() << OP_RETURN << ParseHex("00DAE69F877C357A193BB782BEBA2FE506C1179C21850B47DC5228C592CF800E05BCD515FD27937A00DAE69F877C357A193BB782BEBA2FE506C1179C21850B47DC5228C592CF800E05BCD515FD27937A00");
    ...
    t.vout.resize(2);
    t.vout[0].scriptPubKey = CScript() << OP_RETURN << ParseHex("00DAE69F877C357A193BB782BEBA2FE506C1179C21850B47DC5228C592CF800E05BCD515FD27937A");
    t.vout[1].scriptPubKey = CScript() << OP_RETURN << ParseHex("00DAE69F877C357A193BB782BEBA2FE506C1179C21850B47DC5228C592CF800E05BCD515FD27937A");
    BOOST_CHECK(!IsStandardTx(t, reason));
