...
/** Default for -blockenoughvoteswaittime, which sets the time to wait for enough stake vote transactions that might be in transit when creating a block **/
static const unsigned int DEFAULT_BLOCK_ENOUGH_VOTES_WAIT_TIME = 10;
