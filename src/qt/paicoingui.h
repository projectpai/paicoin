...
#ifndef PAICOIN_QT_PAICOINGUI_H
#define PAICOIN_QT_PAICOINGUI_H
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a paicoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QAction *viewInvestorKeyAction;
    QAction *reviewPaperKeyAction;
...
private Q_SLOTS:
    ...
    /** Switch to page shown before Set PIN page */
    void goBackFromSetPinPage();
