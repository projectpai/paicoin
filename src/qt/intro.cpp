    ...
    signalled(false)
{
    ...
    QString storageRequiresMsg = tr("The blockchain data will be stored in this directory, and it will grow over time.");
    if (pruneTarget) {
...
bool Intro::pickDataDirectory(bool useDefault)
{
     ...
     * override -datadir in the paicoin.conf file in the default data directory
     * (to be consistent with paicoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
