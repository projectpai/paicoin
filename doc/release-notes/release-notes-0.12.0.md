...
- #7209 `f3ad812` test: don't override PAICOIND and PAICOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add PAICOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "PAI" (Ross Nicoll)
