...
unlocked to sign the PAIcoin-Core.app bundle.
...
allowing somebody to distribute a PAIcoin-Core.app or paiup-setup.exe with a valid
...
that the paiup.exe file inside the installer had not been tampered with.
