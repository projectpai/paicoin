...
unlocked to sign the PAI Coin-Qt.app bundle.
...
allowing somebody to distribute a PAI Coin-Qt.app or paicoin-qt-setup.exe with a valid
...
that the paicoin-qt.exe file inside the installer had not been tampered with.
