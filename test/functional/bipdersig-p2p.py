...
class BIP66Test(PAIcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # paicoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and paicoind produces more specific reject
            # reasons.
