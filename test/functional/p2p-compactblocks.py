...
# TestNode: A peer we use to send messages to paicoind, and store responses.
...
class CompactBlocksTest(PAIcoinTestFramework):
    ...
    # This test actually causes paicoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that paicoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for paicoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # paicoind will not send blocktxn responses for blocks whose height is
