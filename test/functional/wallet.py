...
class WalletTest(PAIcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Sendmany 10 PAI with subtract fee from amount
        ...
        # Below test considered unuseful and taken out
        # it fails because outputs with value of zero are considered unuseful,
        # see wallet.cpp line 3203 in AvailableCoins
