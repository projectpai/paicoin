...
class BIP68_112_113Test(ComparisonTestFramework):
        ...
        for b31 in range(2):
            ...
            for b25 in range(2):
                ...
                for b22 in range(2):
                    b18txs = []
                    for b18 in range(2):
                        tx =  self.create_transaction(self.nodes[0], bip68inputs[i], self.nodeaddress, Decimal("1499.98"))
                        i += 1
    ...
    def create_bip112special(self, input, txversion):
        tx = self.create_transaction(self.nodes[0], input, self.nodeaddress, Decimal("1499.98"))
        tx.nVersion = txversion
        ...
        for b31 in range(2):
            ...
            for b25 in range(2):
                ...
                for b22 in range(2):
                    b18txs = []
                    for b18 in range(2):
                        tx =  self.create_transaction(self.nodes[0], bip112inputs[i], self.nodeaddress, Decimal("1499.98"))
                        i += 1
    ...
    def get_tests(self):
        ...
        bip113tx_v1 = self.create_transaction(self.nodes[0], bip113input, self.nodeaddress, Decimal("1499.98"))
        bip113tx_v1.vin[0].nSequence = 0xFFFFFFFE
        bip113tx_v1.nVersion = 1
        bip113tx_v2 = self.create_transaction(self.nodes[0], bip113input, self.nodeaddress, Decimal("1499.98"))
