...
By default, paicoind will dump mempool on shutdown and
...
class MempoolPersistTest(PAIcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give paicoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent paicoind from writing mempool.dat to disk. Verify that `savemempool` fails")
