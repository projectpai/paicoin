...
Contains files used to package paicoind/paiup
...
PGP keys used for signing PAIcoin Core [Gitian release](/doc/release-process.md) results.
...
Utilities to generate test vectors for the data-driven PAIcoin tests.

### [Verify Binaries](/contrib/verifybinaries) ###
This script attempts to download and verify the signature file SHA256SUMS.asc from paicoin.org.
